document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (isRequired && !validators.required(value)) {
        ...
        } else if (field.dataset.minLength && !validators.minLength(value, field.dataset.minLength)) {
          errorMsg = errorMessages.minLength;
        }
      }
  ...
  const animationTargets = document.querySelectorAll(
    ...
    '.section-title, .hero-content, .cta-block'
  );
  ...
  if (!document.getElementById('fade-in-styles')) {
    ...
    style.textContent = [
      ...
      '}',
      '.' + OBSERVED_CLASS + '.' + ANIMATION_CLASS + ' {',
      '  opacity: 1;',
  ...
  if ('IntersectionObserver' in window) {
    ...
    document.querySelectorAll('.' + OBSERVED_CLASS).forEach(function (el) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '33aede40-1c65-4544-81b3-a5d975d04133',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '33aede40-1c65-4544-81b3-a5d975d04133';
...
(function() {
    ...
    form.addEventListener('submit', function(e) {
      ...
      const fullname = form.querySelector('#club-fullname')?.value.trim();
      const phone = form.querySelector('#club-phone')?.value.trim();
      const email = form.querySelector('#club-email')?.value.trim();
      ...
      const btn = form.querySelector('.club-submit-btn');
      const originalHTML = btn.innerHTML;
      btn.innerHTML = '<span>✓ נרשמתם בהצלחה!</span>';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '33aede40-1c65-4544-81b3-a5d975d04133';
